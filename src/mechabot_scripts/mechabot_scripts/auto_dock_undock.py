...
class SimpleDockingNode(Node):
    ...
    def camera_callback(self, msg):
        ...
        if self.frame is not None:
            ...
            if points is not None:
                ...
                cv2.circle(self.frame, (center_x, center_y), 7, (255, 0, 0), 2) #qr circle
                cv2.circle(self.frame, (320, center_y), 5, (255, 255, 0), -1) #frame circle
    ...
    def lidar_callback(self, msg):
        ...
        front = front[~np.isnan(front)]  # Remove NaN- infinite ray from list
        if len(front) > 0:
